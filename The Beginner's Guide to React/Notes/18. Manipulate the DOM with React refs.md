...
## Code
```bash
{"plunker_url":"https://codesandbox.io/embed/github/kentcdodds/beginners-guide-to-react/tree/codesandbox/17-dom-refs?fontsize=14&hidenavigation=1&theme=dark"}
```